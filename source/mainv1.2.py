...
while True:
    ...
    if handsPoints:
        ...
        if contador == 5:
            ...
            if posicao_inicial_da_mao[0] + zona_livre[0] > pontos[0][0] > posicao_inicial_da_mao[0] - zona_livre[0] and posicao_inicial_da_mao[1] + zona_livre[1] > pontos[1][1] > posicao_inicial_da_mao[1] - zona_livre[1]:
                cv2.putText(img, str("Dentro da zona"), (6, 470), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 1)
                ...
                if 2 <= millis <= 60:
                    if ja_reproduziu:
                        ...
                        if not reproduzindo:
                            ja_reproduziu = multiprocessing.Process(target=Pygame.reproduzir, args=(pasta_beep1, ))
                ...
                cv2.putText(img, str("Fora da zona"), (6, 470), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
